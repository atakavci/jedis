...
public abstract class MaintenanceEvent {
   ...
   * {@code ttlSeconds}.
   */
  public static final class MovingEvent extends MaintenanceEvent {
   ...
   * diagnostic.
   */
  public static final class MigratingEvent extends MaintenanceEvent {
    final long ttlSeconds;
   ...
   * diagnostic.
   */
  public static final class FailingOverEvent extends MaintenanceEvent {
    final long ttlSeconds;
    final String shardIds;
  ...
  public static final class MigratedEvent extends MaintenanceEvent {
    final String shardIds;
  ...
  public static final class FailedOverEvent extends MaintenanceEvent {
    final String shardIds;
